...
const Footer = () => {
    ...
    return (
        <footer
            ref={ref}
            id="contactus"
            className="relative isolate mt-6 px-4 py-8 sm:mt-20 sm:px-8 sm:py-12"
        >
            ...
            <div className={`${isVisible ? "in-view" : ""} mx-auto w-full max-w-7xl rounded-2xl border border-border/70 bg-card/55 p-5 shadow-lg backdrop-blur sm:rounded-3xl sm:p-8`}>
                <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
                    <div className="reveal-right flex flex-col gap-3">
                        <Image
                            ...
                            width={320}
                            height={60}
                            className="shrink-0 invert dark:invert-0 w-[160px] sm:w-[240px] h-auto"
                        />
                    ...
                    <div className="reveal flex flex-col gap-2 text-sm sm:gap-3 sm:text-lg">
                    ...
                    <div className="reveal-left flex items-center gap-3">
                        <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="inline-flex h-12 w-12 items-center justify-center rounded-full border border-border/70 bg-background/65 text-foreground/80 transition-colors hover:bg-accent hover:text-accent-foreground sm:h-18 sm:w-18"
                            aria-label="X"
                        >
                            <FaXTwitter className="text-3xl sm:text-5xl" />
                        </a>
                        <a
