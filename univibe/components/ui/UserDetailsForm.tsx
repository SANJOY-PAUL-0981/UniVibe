...
const hobbyOptions = [
    ...
    "Music", "Art", "Travel", "Fitness", "Coding",
    "Writing", "Dancing", "Gardening", "Sports", "Yoga",
]
                                ...
                                <CardContent className="flex flex-col gap-4 pb-6">
                                    <div className="flex flex-col gap-1">
                                        <div className="flex items-center justify-between">
                                            <Label>Hobbies</Label>
                                            <span className="text-xs text-muted-foreground">{selectedHobbies.length}/{MAX_HOBBIES}</span>
                                        </div>
                                        ...
                                        <div className="min-h-9 flex flex-wrap gap-1.5 rounded-md border-input bg-transparent px-2.5 py-1.5 border">
                                            {selectedHobbies.map((hobby) => (
                                                <Badge key={hobby} variant="secondary" className="flex items-center gap-1 h-6 text-xs">
                                                    {hobby}
                                                    <button
                                                        type="button"
                                        ...
                                        {selectedHobbies.length < MAX_HOBBIES && (
                                            ...
                                            >
                                                <ComboboxInput
                                                    ...
                                                    value={hobbyInput}
                                                    onChange={(e) => setHobbyInput((e.target as HTMLInputElement).value)}
                                                    onKeyDown={(e) => {
                                                ...
                                                />
                                                <ComboboxContent>
                                                    <ComboboxEmpty>Press Enter to add "{hobbyInput}"</ComboboxEmpty>
                                                    <ComboboxList>
                                        ...
                                        {selectedHobbies.length >= MAX_HOBBIES && (
                                            <p className="text-xs text-muted-foreground">Maximum of {MAX_HOBBIES} hobbies reached.</p>
                                        )}
                                    </div>
